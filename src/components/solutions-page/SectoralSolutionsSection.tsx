  ...
  const sectoralSolutions = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1516549655103-9550d315e2c5?auto=format&fit=crop&w=800",
      fallbackImage:
        "https://images.unsplash.com/photo-1538108149393-fbbd81895907?auto=format&fit=crop&w=800",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1581092921461-39b11a63ae62?auto=format&fit=crop&w=800",
      fallbackImage:
        "https://images.unsplash.com/photo-1624397640148-949b1732bb0a?auto=format&fit=crop&w=800",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1580674285054-bed31e145f59?auto=format&fit=crop&w=800",
      fallbackImage:
    ...
    },
    {
      ...
      fallbackImage:
        "https://images.unsplash.com/photo-1519619091416-f5d7e5200702?auto=format&fit=crop&w=800",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1557597774-9d273605dfa9?auto=format&fit=crop&w=800",
      fallbackImage:
        "https://images.unsplash.com/photo-1503529896844-8e4ce0734120?auto=format&fit=crop&w=800",
                    ...
                    <Image
                      ...
                      onError={(e) => {
                        e.currentTarget.src =
                          ...
                          "https://images.unsplash.com/photo-1531297484001-80022131f5a1?auto=format&fit=crop&w=800";
