    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h2 className="text-3xl font-bold mb-4 text-gray-800">Hedefler</h2>
          <div className="w-16 h-1 bg-turna-500 mx-auto mb-6"></div>
          <p className="text-gray-600">
            Turna.io'nun güvenlik ve acil durum yönetimi çözümleriyle aşağıdaki hedeflere ulaşabilirsiniz.
          </p>
        </div>
