        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <img
              ...
              alt="Güvenlik Sistemleri Kurulumu"
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 mb-8">
              Turna.io güvenlik ve acil durum yönetimi çözümlerinin uygulanması, aşağıdaki adımları içeren kapsamlı bir süreçtir:
            </p>
