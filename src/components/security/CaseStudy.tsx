    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h2 className="text-3xl font-bold mb-4 text-gray-800">Başarı Hikayesi</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-8 lg:p-12">
              <h3 className="text-2xl font-bold mb-4 text-gray-800">
                Metropol Cezaevi Güvenlik Sistemi
              </h3>
              <p className="text-gray-600 mb-6">
                Türkiye'nin en büyük cezaevlerinden birinde, Turna.io RTLS çözümleri kullanılarak mahkum ve personel takip sistemi kuruldu. Bu sayede:
              </p>
              ...
              <div>
                <button className="text-turna-500 font-medium flex items-center hover:text-turna-600 transition-colors">
                  Detaylı Vaka Çalışmasını İncele
            ...
            <div className="bg-gray-200">
              <img 
                ...
                alt="Güvenlik Sistemleri Vaka Çalışması" 
