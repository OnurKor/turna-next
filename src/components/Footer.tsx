    ...
    <footer className="bg-gray-300 text-gray-700 pt-8 pb-3">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-4">
          ...
          {/* Column 2: Solutions */}
          <div>
            <h3 className="text-xl font-semibold mb-4 text-gray-800">{t('footer.solutions')}</h3>
            <ul className="space-y-2 text-gray-600">
              <li>
                <Link href="/cozumler" className="text-md hover:text-turna-500 transition-colors">
                  {t('footer.indoorSolutions')}
                </Link>
              </li>
              <li>
                <Link href="/cozumler" className="text-md hover:text-turna-500 transition-colors">
                  {t('footer.sectoralSolutions')}
                </Link>
              </li>
            </ul>
          </div>
          ...
          {/* Column 3: Company */}
          <div>
            <h3 className="text-xl font-semibold mb-4 text-gray-800">{t('footer.company')}</h3>
            <ul className="space-y-2 text-gray-600">
              <li>
          ...
          {/* Column 4: Legal */}
          <div>
            <h3 className="text-xl font-semibold mb-4 text-gray-800">{t('footer.legal')}</h3>
            <ul className="space-y-2 text-gray-600">
              <li>
