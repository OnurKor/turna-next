  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-turna-700 via-turna-600 to-turna-500 text-white">
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        ...
        <div
          className="absolute bottom-[20%] right-[10%] w-32 h-32 bg-turna-400 rounded-full opacity-10 animate-float"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-[40%] right-[30%] w-16 h-16 bg-turna-200 rounded-full opacity-10 animate-float"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex justify-center">
            <div className="relative w-full max-w-md">
              ...
              <div
                className="absolute -bottom-6 -right-6 w-12 h-12 bg-turna-300 rounded-full opacity-20 animate-pulse"
                style={{ animationDelay: "0.5s" }}
              ></div>

              {/* Main Visual - Now an actual image instead of decorated div */}
              <div
                className="relative rounded-2xl overflow-hidden shadow-xl border border-white/20 animate-float"
