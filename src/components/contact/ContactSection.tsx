...
const ContactSection = () => {
  ...
  const validationSchema = Yup.object({
    ...
    email: Yup.string().email(t('contactUs.form.errors.emailInvalid')).required(t('contactUs.form.errors.emailRequired')),
    phone: Yup.string(),
    company: Yup.string(),
    message: Yup.string().min(10, t('contactUs.form.errors.message')).required(t('contactUs.form.errors.messageRequired')),
  });
    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800">{t('contactUs.title')}</h2>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex">
                  ...
                  <p className="text-gray-600">Ostim OSB Mahallesi Cevat Dündar Caddesi No: 1/1 İç Kapı No: 10 Yenimahalle/ANKARA</p>
                </li>
                <li className="flex">
                  <Phone className="h-5 w-5 text-turna-500 mr-3 flex-shrink-0" />
                  <p className="text-gray-600">03123873777</p>
                </li>
                <li className="flex">
