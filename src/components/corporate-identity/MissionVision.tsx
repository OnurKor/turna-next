    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">{t('company.missionVision')}</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden transform transition-all hover:-translate-y-2 hover:shadow-xl">
            ...
            <div className="p-8">
              ...
              <h3 className="text-2xl font-bold text-center text-gray-800 mb-4">{t('company.mission')}</h3>
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden transform transition-all hover:-translate-y-2 hover:shadow-xl">
            ...
            <div className="p-8">
              ...
              <h3 className="text-2xl font-bold text-center text-gray-800 mb-4">{t('company.vision')}</h3>
              <p className="text-gray-600 leading-relaxed text-center">
        ...
        <div className="mt-16 bg-white rounded-xl shadow-lg p-8">
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="md:w-1/2">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">{t('company.technologySolutions')}</h3>
