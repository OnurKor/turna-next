...
import { Tv, Radio, Play } from '@/lib/icons'; 
    ...
    <section className="relative bg-gradient-to-r from-turna-700 to-turna-500 text-white py-20 md:py-28">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-5xl font-bold mb-6">Eğlence RTLS Çözümleri</h1>
          <p className="text-xl opacity-90 mb-8 max-w-3xl mx-auto">
            Eğlence merkezlerinde müşteri deneyimini iyileştirme ve mekân içi operasyonları düzenleme çözümlerimizle eğlence sektörüne değer katıyoruz
          </p>
